        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a id="log-in" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in"></span> Entrar <span class="badge"></span></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                    ...
                    <div class="col-md-5 col-md-offset-1">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form id="form-login" method="POST" action="Servlet_login" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9">
                                            ...
                                            <p   class="text-danger " id="mensajeError"></p>
                                        </div>
                                    </div>

                                    <div class="form-group last">
                                        <div class="col-sm-offset-3 col-sm-9">
                                            <input id="boton-entrar" type="submit" value="Inicia Session" class="btn btn-success btn-sm" />
